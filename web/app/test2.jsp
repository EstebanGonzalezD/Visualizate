<%-- 
    Document   : test2
    Created on : 7/06/2020, 08:51:00 AM
    Author     : Esteban
--%>
        ...
        <div class="card title bg-light">
            ...
            <div class="card-body">
                <div class="card-title-container">
                    <h5 class="card-title text-center">TEST N°2</h5>
                    <hr>
                </div>
                <form method ="post" action="test" id="formulario">
                    ...
                    <div class="card-text">
                        <p class="question-title">
                            <i class="fas fa-chevron-circle-right"></i>
                            ¿Gira la cabeza cuando lee y escribe o/y necesita seguir las líneas con el dedo?
                        </p>
                        <div class="form-check radio-item">
                    ...
                    <div class="col text-center">
                        <a href="${pageContext.request.contextPath}/app/index_test.jsp" class="btn btn-start-test">Atrás</a>
                         <input type="hidden" name="pagina" value="test_2">
